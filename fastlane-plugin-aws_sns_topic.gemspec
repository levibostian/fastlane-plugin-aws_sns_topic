...
Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-aws_sns_topic'
  spec.version       = Fastlane::AwsSnsTopic::VERSION
  spec.author        = 'Levi Bostian'
  spec.email         = 'levi.bostian@gmail.com'

  spec.summary       = 'Fastlane plugin to public message to SNS topic.'
  spec.homepage      = "https://github.com/levibostian/fastlane-plugin-aws_sns_topic"
  spec.license       = "MIT"
